	...
	return (
		<main>
			<section className='relative overflow-hidden flex justify-center items-center py-14 md:py-20'>
				...
				/>
				<div className='z-1 relative flex flex-col lg:flex-row gap-6 lg:gap-16 justify-center'>
					<Image
						src={event.imageUrl}
						alt={event.name}
						width={300}
					...
					<div className='flex flex-col'>
						...
						<button className='bg-white/20 lg:mt-auto mt-5 text-lg capitalize w-[95vw] sm:w-full py-2 rounded-md border-white/10 border-2 bg-blur state-effects'>
							Get tickets
						</button>
					</div>
				</div>
